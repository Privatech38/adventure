...
public class NamedRainbowTagTest extends AbstractTest {
  ...
  void testRainbow() {
    ...
    this.assertParsedEquals(expected, input, StandardTags.color(), StandardTags.namedRainbow());
  }

  @Test
  void testRainbowBackwards() {
    final String input = "<yellow>Woo: <rainbow reverse>||||||||||||||||||||||||</rainbow>!";
    final Component expected = empty().color(YELLOW)
      .append(text("Woo: "))
      .append(virtualOfChildren(textOfChildren(
        text("|", color(0xff003f)),
  ...
  void testRainbowPhase() {
    final String input = "<yellow>Woo: <rainbow phase=2>||||||||||||||||||||||||</rainbow>!";
    final Component expected = empty().color(YELLOW)
      .append(text("Woo: "))
      .append(virtualOfChildren(textOfChildren(
        text("|", color(0xcbff00)),
  ...
  void testRainbowPhaseBackwards() {
    final String input = "<yellow>Woo: <rainbow reverse phase=2>||||||||||||||||||||||||</rainbow>!";
    final Component expected = empty().color(YELLOW)
      .append(text("Woo: "))
      .append(virtualOfChildren(textOfChildren(
        text("|", color(0xfff200)),
  ...
  void testRainbowBackwardsWithInsertion() {
    final String input = "<yellow>Woo: <insert:test><rainbow reverse>||||||||||||||||||||||||</rainbow>!";
    final Component expected = empty().color(YELLOW)
      .append(text("Woo: "))
      .append(empty().insertion("test")
        .append(virtualOfChildren(textOfChildren(
  ...
  void testRainbowBackwardsWithInnerClick() {
    final String input = "Rainbow: <rainbow reverse phase=0><click:open_url:'https://github.com'>GH</click></rainbow>";
    final Component expected = text("Rainbow: ")
      .append(virtualOfChildren(
        empty()
          .clickEvent(openUrl("https://github.com"))
  ...
  @Test
  void gh1040() {
    final String input = "<rainbow phase=16777215>||||||||||";
    final Component expected = virtualOfChildren(
      textOfChildren(
        text("|", color(0x00ffff)),
        text("|", color(0x0065ff)),
